...
$answerAskPrefix = vox_control_id('vox-answer-ask');
$answerAskNameId = $answerAskPrefix . '-name';
$answerAskEmailId = $answerAskPrefix . '-email';
$answerAskBodyId = $answerAskPrefix . '-body';
?>
    ...
    <div class="vox-form">
        <form class="vox-form__element" data-vox-form data-entry-list="<?= htmlspecialchars($voxAnswersListId) ?>">
            ...
            <div class="ds-field vox-field">
                <label class="ds-label vox-form__label" for="<?= htmlspecialchars($answerAskBodyId) ?>">Question</label>
                <textarea id="<?= htmlspecialchars($answerAskBodyId) ?>" name="body" class="ds-input vox-textarea" rows="4" placeholder="What would you like to know?" required></textarea>
